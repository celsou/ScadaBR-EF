...
fuscabr.align.createInterface = function() {
	...
	html += "  </style>";
	html += "  <div>";
	html += "    <p class='blcElm boldElm'>ALIGN ELEMENTS</p>";
	html += "    <input type='button' id='fuscabr-align-start-stop' class='blcElm' onclick='fuscabr.align.start()' value='Start alignment'>";
	html += "  </div>";
	html += "  <div id='fuscabr-align-controls' style='display: none;'>";
	html += "	<input type='button' class='blcElm' onclick='fuscabr.align.restart()' value='Clear selection (S)'>";
	html += "	<p class='blcElm boldElm'>Anchor position:</p>";
	...
	html += "	</div>";
	html += "    <p class='blcElm boldElm'>Alignment options:</p>";
	html += "    <p class='blcElm'>Align:</p>";
	html += "    <input type='button' class='blcElm' value='Left (A)' onclick='fuscabr.align.alignLeft()'>";
	html += "    <input type='button' class='blcElm' value='Right (D)' onclick='fuscabr.align.alignRight()'>";
	html += "    <input type='button' class='blcElm' value='Top (W)' onclick='fuscabr.align.alignTop()'>";
	html += "    <input type='button' class='blcElm' value='Bottom (X)' onclick='fuscabr.align.alignBottom()'>";
	html += "    <p class='blcElm'>Center:</p>";
	html += "    <input type='button' class='blcElm' value='Horizontally (F)' onclick='fuscabr.align.centerHorizontal()'>";
	html += "    <input type='button' class='blcElm' value='Vertically (G)' onclick='fuscabr.align.centerVertical()'>";
	html += "    <p class='blcElm'>Distribute:</p>";
	html += "    <input type='button' class='blcElm' value='Horizontally (R)' onclick='fuscabr.align.distributeHorizontal()'>";
	html += "    <input type='button' class='blcElm' value='Vertically (T)' onclick='fuscabr.align.distributeVertical()'>";
	html += "  </div>";
	html += "  <p class='blcElm' style='margin-top: 10px; font-style: italic;'>FUScaBR Library</p>";
...
fuscabr.align.start = function() {
	...
	document.getElementById("fuscabr-align-start-stop").value = "Stop alignment (Esc)";
...
fuscabr.align.stop = function() {
	...
	document.getElementById("fuscabr-align-start-stop").value = "Start alignment";
