 ...
 * @author Matthew Lohbihler
 */
public class EBI25DataSourceRT extends PollingDataSource
		implements com.serotonin.modbus4j.messaging.MessagingExceptionHandler {
	...
	protected LocalizableMessage getLocalExceptionMessage(Exception e) {
		if (e instanceof ExceptionResultException) {
			...
			return new LocalizableMessage("event.ebi25.readError", ere.getKey(),
					ere.getExceptionResult().getExceptionMessage());
		}
